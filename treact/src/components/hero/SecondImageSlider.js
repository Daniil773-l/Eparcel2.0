            ...
            <TwoColumn>
                ...
                <RightColumn>
                    <Content>
                        ...
                        <Paragraph>Клиенты нашего сайта могут отправлять все свои онлайн-покупки, сделанные в турецких интернет-магазинах, на адрес склада, полученный при регистрации. Склад расположен в г. Стамбуле вблизи с Международным аэропортом, откуда ежедневно вылетают карго рейсы в Россию, что сокращает время доставки.</Paragraph>
                        <Actions>
