...
import  DesignIllustration from "../../images/TarrifHeade.svg"
        ...
        <>
            ...
            <Container>
                <TwoColumn>
                    <LeftColumn>
                        <Heading>
                            Тарифы для выгодных покупок вместе с Eparcel.kz
                        </Heading>
                        <Paragraph>
                            Доставка товаров осуществляется компанией Eparcel по тарифам в зависимости от региона, в котором Вы проживаете
                        </Paragraph>
