...
export default ({
                    ...
                    description = "Склад в США расположен в безналоговом штате Делавэр, на адрес которого покупатели из России могут отправить свои товары, купленные в онлайн магазинах, а их мы доставим на Ваш адрес в России.\n\nПокупайте товары в США и указывайте в магазине адрес, который Вы получили при регистрации. Надежная доставка товаров из США до Вашего дома – полностью на нас.",
                }) => {
    return (
        <Container>
            <TwoColumn>
