...
const Image = styled.img(props => [
    ...
    tw`max-w-full h-auto`, // Make the image responsive
]);
...
export default ({
                    ...
                    imageBorder = false,
                    imageShadow = false,
                    imageWidth = 640, // example width in pixels
                    imageHeight = 640, // example height in pixels
    ...
    return (
        <Container>
            <ContentWithPaddingXl>
                <Row>
                    <ImageColumn>
                        <Image src={imageSrc} imageBorder={imageBorder} imageShadow={imageShadow} imageRounded={imageRounded} style={{ width: '100%', height: 'auto' }} />
                    </ImageColumn>
