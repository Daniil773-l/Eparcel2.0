...
import  DesignIllustration from "../../images/News.svg"
        ...
        <>
            ...
            <Container>
                <TwoColumn>
                    <LeftColumn>
                        <Heading>
                            Идеи для покупок, советы и многое другое от Eparcel.kz                        </Heading>
                        <Paragraph>
                            Мы собрали для вас самую интересную и свежую информацию, а также расскажем как сэкономить время и деньги.                        </Paragraph>
