...
import  DesignIllustration from "../../images/Shop.svg"
        ...
        <>
            ...
            <Container>
                <TwoColumn>
                    <LeftColumn>
                        <Heading>
                            Список популярных магазинов
                        </Heading>
                        <Paragraph>
                            Мы собрали для вас лучшие магазины в каждой категории. Большой ассортимент, приемлемые цены и частые распродажи.
                        </Paragraph>
