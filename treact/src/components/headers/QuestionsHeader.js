...
import  DesignIllustration from "../../images/FAQ.svg"
            ...
            <Container>
                <TwoColumn>
                    <LeftColumn>
                        ...
                        <Paragraph>
                            Найти ответы на свои вопросы легко! Наша страница с часто задаваемыми вопросами и найдите полезные сведения о наших продуктах и услугах.                      </Paragraph>
